<?php
	...
	$cat = array(
		 ...
		 */
			...
			'polls:settings:group:title' => "Enquestes del grup",
			...
			'polls:settings:group_profile_display:title' => "Si les enquestes del grup estan activades, on seran mostrats els continguts de l'enquesta al perfil del grup?",
			...
			'polls:settings:group_access:title' => "Si les enquestes del grup estan activades, qui pot crear enquestes?",
			'polls:settings:group_access:admins' => "només propietaris del grup i admins",
			'polls:settings:group_access:members' => "qualsevol membre del grup",
			'polls:settings:front_page:title' => "Admins poden afegir enquestes a la pàgina principal (requereix suport del tema)",
			...
			'polls:settings:site_access:title' => "Qui pot crear enquestes al lateral?",
	     ...
	     **/
			...
			'polls:widget:think' => "%s digues que penses!",
